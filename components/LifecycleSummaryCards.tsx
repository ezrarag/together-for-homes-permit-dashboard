    ...
    <div className="space-y-3">
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <KpiCard
          ...
          sub="CKAN archive field: Date Opened"
          accent="bg-tfh-blue"
        />
        <KpiCard
          label="Permits Issued"
          value={metrics.permitsIssued.toLocaleString()}
          sub="CKAN archive field: Date Issued"
        ...
        />
        <KpiCard
          label="Permits Marked Units Added"
          value={metrics.unitsApproved.toLocaleString()}
          sub="Permit-count proxy, not numeric units"
          accent="bg-green-400"
        />
      </div>
      ...
      <div className="flex flex-wrap items-start gap-2">
        ...
        <StatusPill
          ...
          color="bg-amber-400"
          note="requires live LMS source"
        />
        <StatusPill
          label="Pending Client"
          count={metrics.pendingClient}
          color="bg-gray-300"
          note="not in CKAN archive"
        />
